...
void ActivePathRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout) {
...
void ActivePathRenderSystem::createPipeline(VkRenderPass renderPass) {
	...
	pipeline = std::make_unique<Pipeline>(
		device,
		"shaders/active_path.vert.spv",
		"shaders/path.frag.spv",
		pipelineConfig);
}

void ActivePathRenderSystem::render(FrameInfo& frameInfo) {
