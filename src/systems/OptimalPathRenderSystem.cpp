...
void OptimalPathRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout) {
...
void OptimalPathRenderSystem::createPipeline(VkRenderPass renderPass) {
...
void OptimalPathRenderSystem::render(FrameInfo& frameInfo) {
